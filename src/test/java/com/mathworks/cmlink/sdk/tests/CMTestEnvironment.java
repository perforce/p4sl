...
/**
 * This class is used to set up a test environment for a CM Adapter
 * implementation.
 */
public interface CMTestEnvironment {
	 ...
	 *
	 * @param repositoryDir
	 *            The directory in which to create a repository.
	 ...
	 *
	 * @param repositorySpecifierString
	 *            The repository for which the sandbox will be created.
	 * @param sandboxDir
	 *            The location of the sandbox to create.
	 * @throws Exception
	 */
	void createSandbox(String repositorySpecifierString, File sandboxDir)
			throws Exception;
